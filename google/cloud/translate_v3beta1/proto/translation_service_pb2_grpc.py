...
from google.cloud.translate_v3beta1.proto import translation_service_pb2 as google_dot_cloud_dot_translate__v3beta1_dot_proto_dot_translation__service__pb2
...
class TranslationService(object):
    ...
    def TranslateText(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.translation.v3beta1.TranslationService/TranslateText',
    ...
    def DetectLanguage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.translation.v3beta1.TranslationService/DetectLanguage',
    ...
    def GetSupportedLanguages(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.translation.v3beta1.TranslationService/GetSupportedLanguages',
    ...
    def BatchTranslateText(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.translation.v3beta1.TranslationService/BatchTranslateText',
    ...
    def CreateGlossary(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.translation.v3beta1.TranslationService/CreateGlossary',
    ...
    def ListGlossaries(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.translation.v3beta1.TranslationService/ListGlossaries',
    ...
    def GetGlossary(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.translation.v3beta1.TranslationService/GetGlossary',
    ...
    def DeleteGlossary(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.translation.v3beta1.TranslationService/DeleteGlossary',
