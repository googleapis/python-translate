...
__protobuf__ = proto.module(
    package="google.cloud.translate.v3",
    manifest={
...
class TranslateTextResponse(proto.Message):
    ...
    Attributes:
        translations (Sequence[~.translation_service.Translation]):
            ...
            [``contents``][google.cloud.translate.v3.TranslateTextRequest.contents].
        glossary_translations (Sequence[~.translation_service.Translation]):
            ...
            [``translations``][google.cloud.translate.v3.TranslateTextResponse.translations]
