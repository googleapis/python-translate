...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (TranslationServiceClient, transports.TranslationServiceRestTransport, "rest", "true"),
    (TranslationServiceClient, transports.TranslationServiceRestTransport, "rest", "false"),
])
@mock.patch.object(TranslationServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TranslationServiceClient))
@mock.patch.object(TranslationServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TranslationServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    TranslationServiceClient, TranslationServiceAsyncClient
])
@mock.patch.object(TranslationServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TranslationServiceClient))
@mock.patch.object(TranslationServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TranslationServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (TranslationServiceClient, transports.TranslationServiceGrpcTransport, "grpc", grpc_helpers),
    (TranslationServiceAsyncClient, transports.TranslationServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (TranslationServiceClient, transports.TranslationServiceRestTransport, "rest", None),
])
...
def test_translation_service_client_client_options_from_dict():
    with mock.patch('google.cloud.translate_v3.services.translation_service.transports.TranslationServiceGrpcTransport.__init__') as grpc_transport:
...
def test_translate_document(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.translate_document),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_batch_translate_document(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_translate_document),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_batch_translate_document_flattened():
    ...
    with mock.patch.object(
        ...
        client.batch_translate_document(
            ...
            input_configs=[translation_service.BatchDocumentInputConfig(gcs_source=translation_service.GcsSource(input_uri='input_uri_value'))],
            output_config=translation_service.BatchDocumentOutputConfig(gcs_destination=translation_service.GcsDestination(output_uri_prefix='output_uri_prefix_value')),
        )
...
def test_translate_text_rest_interceptors(null_interceptor):
    transport = transports.TranslationServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.TranslationServiceRestInterceptor(),
        )
    client = TranslationServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_translate_text") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_translate_text") as pre:
...
def test_translate_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*}:translateText" % client.transport._host, args[1])
...
def test_detect_language_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_detect_language") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_detect_language") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_detect_language_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*}:detectLanguage" % client.transport._host, args[1])
...
def test_get_supported_languages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_get_supported_languages") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_get_supported_languages") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_supported_languages_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*}/supportedLanguages" % client.transport._host, args[1])
...
def test_translate_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_translate_document") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_translate_document") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_batch_translate_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_batch_translate_text") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_batch_translate_text") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_batch_translate_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_batch_translate_document") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_batch_translate_document") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_batch_translate_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*}:batchTranslateDocument" % client.transport._host, args[1])
...
def test_create_glossary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_create_glossary") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_create_glossary") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_glossary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*}/glossaries" % client.transport._host, args[1])
...
def test_list_glossaries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_list_glossaries") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_list_glossaries") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_glossary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_get_glossary") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_get_glossary") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_glossary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/glossaries/*}" % client.transport._host, args[1])
...
def test_delete_glossary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "post_delete_glossary") as post, \
         mock.patch.object(transports.TranslationServiceRestInterceptor, "pre_delete_glossary") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_translation_service_base_transport():
    ...
    with mock.patch('google.cloud.translate_v3.services.translation_service.transports.TranslationServiceTransport.__init__') as Transport:
...
def test_translation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.translate_v3.services.translation_service.transports.TranslationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_translation_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.translate_v3.services.translation_service.transports.TranslationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.TranslationServiceTransport()
        adc.assert_called_once()
...
def test_translation_service_transport_auth_adc(transport_class):
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        ...
        adc.assert_called_once_with(
            scopes=["1", "2"],
            default_scopes=(                'https://www.googleapis.com/auth/cloud-platform',                'https://www.googleapis.com/auth/cloud-translation',),
            quota_project_id="octopus",
        )
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (TranslationServiceAsyncClient, transports.TranslationServiceGrpcAsyncIOTransport),
])
