...
from google.cloud.translation_v3beta1.services.translation_service import (
    TranslationServiceAsyncClient,
)
from google.cloud.translation_v3beta1.services.translation_service import (
    TranslationServiceClient,
)
from google.cloud.translation_v3beta1.services.translation_service import pagers
from google.cloud.translation_v3beta1.services.translation_service import transports
from google.cloud.translation_v3beta1.types import translation_service
...
def test_translation_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.translation_v3beta1.services.translation_service.transports.TranslationServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_translate_text(transport: str = "grpc"):
    client = TranslationServiceClient(
...
def test_detect_language(transport: str = "grpc"):
    client = TranslationServiceClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_detect_language_flattened():
    ...
    with mock.patch.object(type(client._transport.detect_language), "__call__") as call:
        ...
        client.detect_language(
            parent="parent_value", model="model_value", mime_type="mime_type_value",
        )
...
def test_get_supported_languages(transport: str = "grpc"):
    client = TranslationServiceClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_batch_translate_text(transport: str = "grpc"):
    client = TranslationServiceClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_create_glossary(transport: str = "grpc"):
    client = TranslationServiceClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_list_glossaries(transport: str = "grpc"):
    client = TranslationServiceClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_get_glossary(transport: str = "grpc"):
    client = TranslationServiceClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_delete_glossary(transport: str = "grpc"):
    client = TranslationServiceClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_translation_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.translation_v3beta1.services.translation_service.transports.TranslationServiceTransport.__init__"
    ) as Transport:
...
def test_translation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.translation_v3beta1.services.translation_service.transports.TranslationServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
