...
from google.cloud.translation_v3.services.translation_service import (
    TranslationServiceAsyncClient,
)
from google.cloud.translation_v3.services.translation_service import (
    TranslationServiceClient,
)
from google.cloud.translation_v3.services.translation_service import pagers
from google.cloud.translation_v3.services.translation_service import transports
from google.cloud.translation_v3.types import translation_service
...
def test_translation_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.translation_v3.services.translation_service.transports.TranslationServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_translation_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.translation_v3.services.translation_service.transports.TranslationServiceTransport.__init__"
    ) as Transport:
...
def test_translation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.translation_v3.services.translation_service.transports.TranslationServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
